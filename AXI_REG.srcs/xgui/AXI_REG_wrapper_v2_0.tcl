...
source [file join [file dirname [file dirname [info script]]] gui/AXI_REG_wrapper_v2_0.gtcl]
...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DEFAULT_AMOUNT_OF_READ_REGISTERS" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "DEFAULT_AMOUNT_OF_READ_WRITE_REGISTERS" -parent ${Page_0} -widget comboBox
...
proc update_PARAM_VALUE.AMOUNT_OF_READ_REGISTERS { PARAM_VALUE.AMOUNT_OF_READ_REGISTERS PARAM_VALUE.DEFAULT_AMOUNT_OF_READ_REGISTERS } {
	# Procedure called to update AMOUNT_OF_READ_REGISTERS when any of the dependent parameters in the arguments change
	
	set AMOUNT_OF_READ_REGISTERS ${PARAM_VALUE.AMOUNT_OF_READ_REGISTERS}
	set DEFAULT_AMOUNT_OF_READ_REGISTERS ${PARAM_VALUE.DEFAULT_AMOUNT_OF_READ_REGISTERS}
	set values(DEFAULT_AMOUNT_OF_READ_REGISTERS) [get_property value $DEFAULT_AMOUNT_OF_READ_REGISTERS]
	if { [gen_USERPARAMETER_AMOUNT_OF_READ_REGISTERS_ENABLEMENT $values(DEFAULT_AMOUNT_OF_READ_REGISTERS)] } {
		set_property enabled true $AMOUNT_OF_READ_REGISTERS
	} else {
		set_property enabled false $AMOUNT_OF_READ_REGISTERS
	}
}
...
proc update_PARAM_VALUE.AMOUNT_OF_READ_WRITE_REGISTERS { PARAM_VALUE.AMOUNT_OF_READ_WRITE_REGISTERS PARAM_VALUE.DEFAULT_AMOUNT_OF_READ_WRITE_REGISTERS } {
	# Procedure called to update AMOUNT_OF_READ_WRITE_REGISTERS when any of the dependent parameters in the arguments change
	
	set AMOUNT_OF_READ_WRITE_REGISTERS ${PARAM_VALUE.AMOUNT_OF_READ_WRITE_REGISTERS}
	set DEFAULT_AMOUNT_OF_READ_WRITE_REGISTERS ${PARAM_VALUE.DEFAULT_AMOUNT_OF_READ_WRITE_REGISTERS}
	set values(DEFAULT_AMOUNT_OF_READ_WRITE_REGISTERS) [get_property value $DEFAULT_AMOUNT_OF_READ_WRITE_REGISTERS]
	if { [gen_USERPARAMETER_AMOUNT_OF_READ_WRITE_REGISTERS_ENABLEMENT $values(DEFAULT_AMOUNT_OF_READ_WRITE_REGISTERS)] } {
		set_property enabled true $AMOUNT_OF_READ_WRITE_REGISTERS
	} else {
		set_property enabled false $AMOUNT_OF_READ_WRITE_REGISTERS
	}
}
